...
/* @var $searchModel app\models\search\GalleryPhotoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Gallery Photos');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="gallery-photo-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Gallery Photo'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
