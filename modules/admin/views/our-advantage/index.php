...
/* @var $searchModel app\models\search\OurAdvantageSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Our Advantages');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="our-advantage-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Our Advantage'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
