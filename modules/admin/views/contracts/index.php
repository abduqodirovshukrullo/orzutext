...
/* @var $searchModel app\models\search\ContratcsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Contratcs');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="contratcs-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Contratcs'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
