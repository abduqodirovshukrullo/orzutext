...
/* @var $searchModel app\models\search\SertificateImagesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Sertificate Images');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sertificate-images-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Sertificate Images'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
