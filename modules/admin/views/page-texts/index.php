...
/* @var $searchModel app\models\search\PageTextsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Page Texts');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="page-texts-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Page Texts'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
