...
<div class="products-form">
    ...
    <?= $form->field($model, 'base_file2')->widget(trntv\filekit\widget\Upload::className(), ['url' => app\models\BaseModel::FILE_UPLOAD_URL, 'maxFileSize' => 10*1024*1024]) ?>
    ...
    <?= $form->field($model, 'parent_id')->dropDownList(
        \yii\helpers\ArrayHelper::map(\app\models\Categories::find()->where(['parent_id'=>null])->all(), 'id', 'title_ru'),
        [
...
//                '1' => ['Selected' => true]
    ...
    <?= $form->field($model, 'brand_id')->dropDownList(
        \yii\helpers\ArrayHelper::map(\app\models\Brands::find()->all(), 'id', 'title_ru'),
        [
            'prompt' => 'Choose category',
            'options' => [
            ]
