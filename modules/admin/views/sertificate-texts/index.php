...
/* @var $searchModel app\models\search\SertificateTextsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Sertificate Texts');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sertificate-texts-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Sertificate Texts'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
